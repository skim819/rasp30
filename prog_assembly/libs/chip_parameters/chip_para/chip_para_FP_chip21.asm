...
/* sub threshold */
.set FPS_GATE_S_SWC, 0x2400 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTA, 0x2400 /* Gate(OTA) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTAREF, 0x2400 /* Gate(OTAREF) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_MITE, 0x2400 /* Gate(MITE) = 3.0V @ IVDD 6.0V */
...
.set FPS_GATE_S_DIRSWC, 0x2400 /* Gate(DIRSWC) = 3.0V @ IVDD 6.0V */
...
/* above threshold */
.set FPA_GATE_S_SWC, 0x2400 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTA, 0x2400 /* Gate(OTA) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTAREF, 0x2400 /* Gate(OTAREF) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_MITE, 0x2400 /* Gate(MITE) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_DIRSWC, 0x2400 /* Gate(DIRSWC) = 3.0V @ IVDD 6.0V */
