...
/* above & sub threshold */
.set CP_GATE_S_SWC, 0x5600 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
...
.set CP_GATE_S_MITE, 0x4800 /* Gate(MITE) = 3.0V @ IVDD 6.0V */
.set CP_INJ_T_MITE, 3 /* Injection time (*10us) */
.set CP_NUM_MITE, 20 /* # of Measured Coarse Progrm */
.set CP_GATE_S_DIRSWC, 0x5600 /* Gate(DIRSWC) = 3.0V @ IVDD 6.0V */
