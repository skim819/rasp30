...
//scf(98);
//clf(98);
//No_total=No_of_DACs+No_of_mite;
//for i=1:No_total
//    temp=modulo(i,7)+1;
...
//end
//xtitle("","time [s]", "Vout [V]"); a=gca(); // a.data_bounds=[0 4000; 260 12000]
...
//disp(DAC_map_information_temp)
//disp(DAC_map_information)
