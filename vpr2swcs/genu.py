	...
	#pdb.set_trace()
        for x in range(len(self.li)):
		 ...
		 if self.li[x][y] == 1:
			 ...
			 if swc_name1 in ['cab_vmm.O[5]','cab_vmm.O[6]','cab_vmm.O[7]','vmm12x1[0].in[0]','vmm12x1[0].in[1]','vmm12x1[0].in[2]','vmm12x1[0].in[3]','vmm12x1[0].in[4]','vmm12x1[0].in[5]','vmm12x1[0].in[6]','vmm12x1[0].in[7]','vmm12x1[0].in[8]','vmm12x1[0].in[9]','vmm12x1[0].in[10]','vmm12x1[0].in[11]','vmm8x4_in[0].in[0]','vmm8x4_in[0].in[1]','vmm8x4_in[0].in[2]','vmm8x4_in[0].in[3]','vmm8x4_in[0].in[4]','vmm8x4_in[0].in[5]','vmm8x4_in[0].in[6]','vmm8x4_in[0].in[7]','DAC_sftreg[0].in[0]','DAC_sftreg[0].in[1]','DAC_sftreg[0].in[2]','nmirror[0].in[0]','nmirror_vmm[0].in[0]','th_logic[0].in[0]','th_logic[0].in[1]','th_logic[0].in[2]','th_logic[0].in[3]','th_logic[0].in[4]','th_logic[0].in[5]','th_logic[0].in[6]','th_logic[0].in[7]']:
				 #pdb.set_trace()
