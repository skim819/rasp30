...
j=1; fd = mopen('char_gate_coupling_swc.hex','r'); clear data_swc; m_graph=4; data_swc = [1:m_graph]; 
...
for k=1:Vg06VtoVg00V_swc_sz(1,1)
    for h=1:ADC_vg06_vg00_swc_sz(1,2)
        if ADC_vg06_vg00_swc(h) < Vg06VtoVg00V_swc(k,1) then
            Vg06VtoVg00V_swc(k,2)=fit_vg06_vg00_swc(h);
        end
    end
end
...
j=1; fd = mopen('char_gate_coupling_ota.hex','r'); clear data_ota; m_graph=4; data_ota = [1:m_graph]; 
str_temp = mgetstr(7,fd);
while str_temp ~= "0xffff ",
...
//mclose(fd); data_ota(:,2)=data_ota(:,2)*1e-3; // <- ms
...
for k=1:Vg06VtoVg00V_ota_sz(1,1)
    for h=1:ADC_vg06_vg00_ota_sz(1,2)
        if ADC_vg06_vg00_ota(h) < Vg06VtoVg00V_ota(k,1) then
            Vg06VtoVg00V_ota(k,2)=fit_vg06_vg00_ota(h);
        end
    end
end
...
j=1; fd = mopen('char_gate_coupling_otaref.hex','r'); clear data_otaref; m_graph=4; data_otaref = [1:m_graph]; 
str_temp = mgetstr(7,fd);
while str_temp ~= "0xffff ",
...
for k=1:Vg06VtoVg00V_otaref_sz(1,1)
    for h=1:ADC_vg06_vg00_otaref_sz(1,2)
        if ADC_vg06_vg00_otaref(h) < Vg06VtoVg00V_otaref(k,1) then
            Vg06VtoVg00V_otaref(k,2)=fit_vg06_vg00_otaref(h);
        end
    end
end
...
j=1; fd = mopen('char_gate_coupling_mite.hex','r'); clear data_mite; m_graph=4; data_mite = [1:m_graph]; 
str_temp = mgetstr(7,fd);
while str_temp ~= "0xffff ",
...
//mclose(fd); data_mite(:,2)=data_mite(:,2)*1e-3; // <- ms
...
for k=1:Vg06VtoVg00V_mite_sz(1,1)
    for h=1:ADC_vg06_vg00_mite_sz(1,2)
        if ADC_vg06_vg00_mite(h) < Vg06VtoVg00V_mite(k,1) then
            Vg06VtoVg00V_mite(k,2)=fit_vg06_vg00_mite(h);
        end
    end
end
...
j=1; fd = mopen('char_gate_coupling_dirswc.hex','r'); clear data_dirswc; m_graph=4; data_dirswc = [1:m_graph]; 
str_temp = mgetstr(7,fd);
while str_temp ~= "0xffff ",
...
for k=1:Vg06VtoVg00V_dirswc_sz(1,1)
    for h=1:ADC_vg06_vg00_dirswc_sz(1,2)
        if ADC_vg06_vg00_dirswc(h) < Vg06VtoVg00V_dirswc(k,1) then
            Vg06VtoVg00V_dirswc(k,2)=fit_vg06_vg00_dirswc(h);
        end
    end
end
