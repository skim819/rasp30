...
file19_menu = uimenu("Parent", file_menu, "Label", gettext("3.0a "));
...
function Choose_Board_callback(handles)
    ...
    if (handles.Choose_Board.value == 1) then
        board_num=1;
    elseif (handles.Choose_Board.value == 2) then
        board_num=2;
        disp('You are now using the settings for the 3.0 Board');
    elseif (handles.Choose_Board.value == 3) then
        board_num=3;
        disp('You are now using the settings for the 3.0 A Board');
    elseif (handles.Choose_Board.value == 4) then
        board_num=4;
        disp('You are now using the settings for the 3.0 N Board');
    elseif (handles.Choose_Board.value == 5) then
        board_num=5;
...
function Send_Email_callback(handles)
    ...
    if (email_name == []) then
        ...
        disp('FNAME: ' + fname);
        unix_s('python /home/ubuntu/rasp30/remote_server/send_email.py '+ email_name + ' ' + fname);
        disp("Email Sent!");
