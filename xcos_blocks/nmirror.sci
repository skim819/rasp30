function [x,y,typ]=nmirror(job,arg1,arg2)
    ...
    case 'set' then
        ...
        while %t do
            ...
            [ok,num_io exprs]=scicos_getvalue('Common Source',['Number of I/O'],list('vec',1),exprs)
    ...
    case 'define' then
        ...
        exprs=[sci2exp(num_io)] // exprs MUST BE semicolon separated & sci2exp() also converts an expression to string
