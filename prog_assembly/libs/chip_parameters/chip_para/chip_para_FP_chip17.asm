...
/* sub threshold */
.set FPS_GATE_S_SWC, 0x4a00 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
.set FPS_INJ_T_SWC, 1 /* Injection time (*10us) */
.set FPS_NUM_SWC, 62 /* # of Fine Progrm */
...
.set FPS_GATE_S_OTA, 0x3400 /* Gate(OTA) = 3.0V @ IVDD 6.0V */
.set FPS_INJ_T_OTA, 3 /* Injection time (*10us) */
...
.set FPS_GATE_S_OTAREF, 0x4200 /* Gate(OTAREF) = 3.0V @ IVDD 6.0V */
.set FPS_INJ_T_OTAREF, 6 /* Injection time (*10us) */
...
.set FPS_INJ_T_MITE, 3 /* Injection time (*10us) */
...
.set FPS_GATE_S_DIRSWC, 0x4a00 /* Gate(DIRSWC) = 3.0V @ IVDD 6.0V */
...
/* above threshold */
.set FPA_GATE_S_SWC, 0x4e00 /* Gate(SWC) = 3.0V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTA, 0x4000 /* Gate(OTA) = 3.0V @ IVDD 6.0V */
.set FPA_INJ_T_OTA, 3 /* Injection time (*10us) */
...
.set FPA_GATE_S_OTAREF, 0x4000 /* Gate(OTAREF) = 3.0V @ IVDD 6.0V */
.set FPA_INJ_T_OTAREF, 6 /* Injection time (*10us) */
...
.set FPA_GATE_S_MITE, 0x4c00 /* Gate(MITE) = 3.0V @ IVDD 6.0V */
.set FPA_INJ_T_MITE, 3 /* Injection time (*10us) */
...
.set FPA_GATE_S_DIRSWC, 0x4e00 /* Gate(DIRSWC) = 3.0V @ IVDD 6.0V */
...
.set FPL_GATE_S_OTA, 0x2e00 /* Gate(OTA) = 2.5V */
.set FPL_INJ_T_OTA, 3 /* Injection time (*10us) */
...
.set FPL_GATE_S_OTAREF, 0x3000 /* Gate(OTAREF) = gnd */
...
.set FPL_GATE_S_MITE, 0x3000 /* Gate(MITE) = 2.0V */
.set FPL_INJ_T_MITE, 3 /* Injection time (*10us) */
...
.set FPL_GATE_S_DIRSWC, 0x4000 /* Gate(DIRSWC) = 1.4V */
