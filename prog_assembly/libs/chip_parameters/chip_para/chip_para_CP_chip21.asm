...
.set CPL_GATE_S_OTA, 0x3300 /* Gate(OTA) = 2.4V */
...
.set CPL_GATE_S_MITE, 0x2900 /* Gate(MITE) = 2.2V */
.set CPL_INJ_T_MITE, 1 /* Injection time (*10us) */
.set CPL_NUM_MITE, 20 /* # of Measured Coarse Progrm */
.set CPL_GATE_S_DIRSWC, 0x0100 /* Gate(DIRSWC) = 1.5V */
