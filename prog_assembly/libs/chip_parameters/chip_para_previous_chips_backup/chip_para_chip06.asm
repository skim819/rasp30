...
.set    TUN_TIME_TP_CAB,     80          /* tunneling time for target programming (ms) - CAB */
...
.set    FCP_GATE_S_SWC,    0x5200          /* Gate_S voltage for SWC first coarese program = V @ IVDD 6.0V */
...
.set    FCP_GATE_S_MITE,    0x4600          /* Gate_S voltage for MITE first coarese program = V @ IVDD 6.0V */
.set    FCP_INJ_T_MITE,    3          /* Injection time for MITE first coarese program = *10us */
.set    FCP_GATE_S_DIRSWC,    0x5200          /* Gate_S voltage for SWC first coarese program = V @ IVDD 6.0V */
...
.set    FCPL_GATE_S_OTA,    0x3000          /* Gate_S voltage for OTA low sub Vth first coarese program = V @ IVDD 6.0V */
...
.set    MCP_GATE_S_SWC,    0x5200          /* Gate_S voltage for SWC sub Vth measured coarse program = V @ IVDD 6.0V */
...
.set    MCP_GATE_S_MITE,    0x4600          /* Gate_S voltage for MITE sub Vth measured coarse program = V @ IVDD 6.0V */
.set    MCP_INJ_T_MITE,    3          /* Injection time for MITE sub Vth measured coarse program = *10us */
.set    MCP_GATE_S_DIRSWC,    0x5200          /* Gate_S voltage for SWC sub Vth measured coarse program = V @ IVDD 6.0V */
...
.set    MCPL_GATE_S_OTA,    0x3000          /* Gate_S voltage for OTA low sub Vth measured coarse program = V @ IVDD 6.0V */
...
.set    MCPL_GATE_S_MITE,    0x3000          /* Gate_S voltage for MITE low sub Vth measured coarse program = V @ IVDD 6.0V */
...
.set    FPS_GATE_S_DIRSWC,    0x4600          /* Gate_S voltage for SWC sub Vth fine program = V @ IVDD 6.0V */
...
.set    FPA_GATE_S_DIRSWC,    0x4800          /* Gate_S voltage for SWC above Vth fine program = V @ IVDD 6.0V */
